...
logger = logging.getLogger("machine1")
logging.getLogger("opcua").setLevel(logging.CRITICAL)

# Read configuration from environment variables
OPCUA_SERVER_URL = os.getenv("OPCUA_SERVER_URL", "opc.tcp://gateway:4840")
MACHINE_ID = os.getenv("MACHINE_ID", "Machine1")
SAMPLE_INTERVAL = int(os.getenv("SAMPLE_INTERVAL", "30"))
...
def main():
    ...
    try:
        ...
        while True:
            ...
            logger.info(f"Machine1 - Temperature: {temp}°C, Pressure: {press} hPa, Timestamp: {current_time}")
